...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::products::set_sold_out_today,
            commands::products::delete_product,
            commands::products::get_product_variants,
            commands::products::create_product_variant,
            commands::products::update_product_variant,
            commands::products::delete_product_variant,
            commands::products::get_modifier_groups,
            commands::products::create_modifier_group,
            commands::products::update_modifier_group,
            commands::products::delete_modifier_group,
            commands::products::create_modifier_option,
            commands::products::update_modifier_option,
            commands::products::delete_modifier_option,
            ...
            commands::orders::get_session_order_items,
