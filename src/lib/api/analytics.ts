...
export const getRevenueByPeriod = (period: 'today' | 'week' | 'month' | '3months' | 'year', restaurant_id?: string) =>
...
export const getSlowMovers = (restaurant_id?: string, threshold?: number, days?: number) =>
    call<TopProduct[]>('get_slow_movers', { restaurantId: restaurant_id, threshold, days });
