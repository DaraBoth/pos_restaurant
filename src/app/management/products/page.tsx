                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 relative z-10">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-[var(--background)] border border-[var(--border)] rounded-2xl pl-12 pr-6 py-3 text-sm text-[var(--foreground)] focus:border-[var(--accent)] outline-none transition-all w-full sm:w-64"
                        />
                    </div>
