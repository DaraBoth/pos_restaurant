...
export default function UserModal({ isOpen, onClose, onSave, user }: UserModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center pl-[100px] lg:pl-[280px] bg-black/80 backdrop-blur-sm animate-fade-in" onClick={e => e.target === e.currentTarget && onClose()}>
